      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="lawyers_form.php" class="btn btn-primary" name="save" value="create">
                  Lawyer Enquiry Form
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0">Lawyer Details</h3></div>
              <div class="col-sm-4">
        ...
        <tr>
            ...
            <td>
                <button class="edit-btn btn btn-success btn-sm"
                    data-license_no="<?= $row['License_No'] ?>"
                    ...
                    data-experience="<?= htmlspecialchars($row['Experience'], ENT_QUOTES) ?>">
                    Edit
                </button>
...
$(document).ready(function () {
    ...
    $('.edit-btn').click(function () {
        $('#license_no').val($(this).data('license_no'));
    ...
    $('#editForm').submit(function (e) {
        e.preventDefault();
        $.post('edit_lawyers.php', $(this).serialize(), function (response) {
            alert(response);
    ...
    $('.delete-btn').click(function () {
        if (confirm('Are you sure you want to delete this lawyer?')) {
            $.post('delete_lawyers.php', { License_No: $(this).data('license_no') }, function (response) {
                alert(response);
