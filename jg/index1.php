...
<html lang="en">
  ...
  <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >                    
                  <li class="nav-item">
                    <a href="forms/lawyers_datatable.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Lawyers</p>
                    </a>
                  </li>
              <li class="nav-item">
                     <a href="forms/clients_datatable.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Clients</p>
                    </a>
                  </li>
              <li class="nav-item">
                    <a href="forms/attorney_datatable.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Attorneys</p>
                    </a>
                  </li>
              <li class="nav-item">
                    <a href="forms/cases_datatable.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Cases</p>
                    </a>
                  </li>
              <li class="nav-item">
                    <a href="forms/invoices_datatable.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Invoices</p>
                    </a>
                  </li>            
